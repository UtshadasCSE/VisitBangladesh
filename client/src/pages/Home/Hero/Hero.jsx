    ...
    <div>
      <div className="relative bg-heroBg h-screen  bg-cover bg-center bg-no-repeat font-popins">
        ...
        <div className="relative z-10 text-white p-6 flex flex-col justify-center items-center gap-6 h-full">
          <h1 className="text-xl font-bold tracking-[0.4rem]">PRESENTING</h1>
          <p className="mt-2 text-7xl max-sm:text-xl max-sm:text-center max-sm:leading-10 text-[#e12729] tracking-[1rem]  font-playwrite font-bold">
            MADE IN BANGLADESH
          </p>
